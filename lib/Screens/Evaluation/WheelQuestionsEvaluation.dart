...
class BuildWheelEval extends StatefulWidget {
  BuildWheelEval({Key key, this.quename}) : super(key: key);
  final quename;

  @override
  _BuildWheelEvalState createState() => _BuildWheelEvalState();
}

class _BuildWheelEvalState extends State<BuildWheelEval> {
  int _currentPage = 0;
